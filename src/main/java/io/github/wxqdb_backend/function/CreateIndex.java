...
import io.github.wxqdb_backend.bpulstree.Main;
import org.dom4j.*;
...
public class CreateIndex {
    ...
    public static String createIndexWithReturn(String dbName, String tbName, String index) throws DocumentException, IOException {
        //数据库是否为空
        if(IsLegal.isDatabaseEmpty()){
            return "数据库为空";
        }
